...
FGS_L = {
    enUS = {
        ...
        CANNOT_OPEN_OPTIONS_IN_COMBAT = "Cannot open options panel during combat. Opening after combat ends...",
        OPTIONS_OPENING_AFTER_COMBAT = "Opening options panel...",
        LOADED = "Loaded!",
    ...
    deDE = {
        ...
        CANNOT_OPEN_OPTIONS_IN_COMBAT = "Optionen können nicht während eines Kampfes geöffnet werden. Öffne nach dem Kampf...",
        OPTIONS_OPENING_AFTER_COMBAT = "Öffne Optionenfenster...",
        LOADED = "Geladen!",
